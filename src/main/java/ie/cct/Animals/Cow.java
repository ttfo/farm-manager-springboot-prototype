...
public class Cow extends Animal {
	...
	Float weightThresholdCow = 300.0f; // value defined in CA specs
	Float marketPriceEstimateCow = 500.0f; // value defined in CA specs - current est. of the price of 1 unit of livestock 
